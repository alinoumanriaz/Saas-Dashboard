...
const Page = () => {
  ...
  const { loading, error, data, refetch } = useQuery(GET_PAGE_CONTENT, {
    variables: { slug: "terms-conditions" },
  });
      ...
      <div className="px-6">
        <div className="bg-white rounded-md ring-1 ring-gray-200 overflow-hidden">
          <div className="flex justify-between items-center p-4">
            <h1 className="text-xl">Terms & Conditions Page</h1>
          </div>
        ...
        <div className="p-2">
          {isEditing ? (
            <div className="space-y-6">
              <div className="border border-gray-300  h-[400px] overflow-y-auto  rounded-lg overflow-auto shadow-sm">
                <ToastEditor
            ...
            <div className="prose max-w-none p-4 bg-white  h-[400px] overflow-y-auto rounded-lg border border-gray-200 shadow-sm">
              <div
