      ...
      <div className="px-6">
        <div className="bg-white rounded-md ring-1 ring-gray-200 overflow-hidden">
          <div className="flex justify-between items-center p-4">
            <h1 className="text-xl">Privacy Policy Page</h1>
          </div>
      ...
      <div className="bg-white rounded-md ring-1 ring-gray-200 overflow-hidden">
        ...
        <div className="p-2">
          {isEditing ? (
            ...
            <div className="prose max-w-none p-4  h-[400px] overflow-y-auto  bg-white rounded-lg border border-gray-200 shadow-sm">
              <div
