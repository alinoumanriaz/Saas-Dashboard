...
const UPDATE_TERMS_CONDITIONS_PAGE = gql`
  mutation UpdateTermsConditionsPage($id: ID!, $input: UpdatePageInput!) {
          ...
          <CardContent className="flex flex-col items-center justify-center gap-3 py-16 text-center">
            ...
            <div className="space-y-1">
              <h3 className="text-lg font-semibold">
                Couldn&apos;t load the Terms & Conditions page
              </h3>
    ...
    return (
      <div className="mx-auto min-w-2xl p-6">
        <CardContent className="flex flex-col items-center justify-center gap-3 py-16 text-center">
          ...
          <div className="space-y-1">
            <h3 className="text-lg font-semibold">No Terms & Conditions page yet</h3>
            <p className="text-sm text-muted-foreground">
              Once a Terms & Conditions page is created, it will appear here for editing.
            </p>
          </div>
        </CardContent>
      </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <Input
                        ...
                        placeholder="e.g. Terms & Conditions – Your Company"
                      />
                      <TooltipProvider>
                        <Tooltip>
                  ...
                  <CardContent>
                    <div className="space-y-1 rounded-lg border bg-muted/20 p-4">
                      ...
                      <h3 className="text-xl font-medium text-blue-800 hover:underline dark:text-blue-400">
                        {page.metaTitle || "Terms & Conditions — Your Company"}
                      </h3>
