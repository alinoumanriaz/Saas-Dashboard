...
const UPDATE_CONTACT_US_PAGE = gql`
  mutation UpdateContactUsPage($id: ID!, $input: UpdatePageInput!) {
...
const ContactUsPage = () => {
  ...
  const {
    ...
    data,
    refetch,
  } = useQuery<any>(GET_CONTACT_US_PAGE, {
          ...
          <CardContent className="flex flex-col items-center justify-center gap-3 py-16 text-center">
            ...
            <div className="space-y-1">
              <h3 className="text-lg font-semibold">
                Couldn&apos;t load the Contact Us page
              </h3>
    ...
    return (
      <div className="mx-auto min-w-2xl p-6">
        <CardContent className="flex flex-col items-center justify-center gap-3 py-16 text-center">
          ...
          <div className="space-y-1">
            <h3 className="text-lg font-semibold">No Contact Us page yet</h3>
            <p className="text-sm text-muted-foreground">
              Once a Contact Us page is created, it will appear here for editing.
            </p>
          </div>
        </CardContent>
      </div>
                  ...
                  <CardContent>
                    <div className="space-y-1 rounded-lg border bg-muted/20 p-4">
                      ...
                      <h3 className="text-xl font-medium text-blue-800 hover:underline dark:text-blue-400">
                        {page.metaTitle || "Contact Us — Your Company"}
                      </h3>
