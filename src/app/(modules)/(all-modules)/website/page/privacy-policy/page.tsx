...
const UPDATE_PRIVACY_POLICY_PAGE = gql`
  mutation UpdatePrivacyPolicyPage($id: ID!, $input: UpdatePageInput!) {
          ...
          <CardContent className="flex flex-col items-center justify-center gap-3 py-16 text-center">
            ...
            <div className="space-y-1">
              <h3 className="text-lg font-semibold">
                Couldn&apos;t load the Privacy Policy page
              </h3>
    ...
    return (
      <div className="mx-auto min-w-2xl p-6">
        <CardContent className="flex flex-col items-center justify-center gap-3 py-16 text-center">
          ...
          <div className="space-y-1">
            <h3 className="text-lg font-semibold">No Privacy Policy page yet</h3>
            <p className="text-sm text-muted-foreground">
              Once a Privacy Policy page is created, it will appear here for editing.
            </p>
          </div>
        </CardContent>
      </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <Input
                        ...
                        placeholder="e.g. Privacy Policy – Your Data Rights"
                      />
                      <TooltipProvider>
                        <Tooltip>
                  ...
                  <CardContent>
                    <div className="space-y-1 rounded-lg border bg-muted/20 p-4">
                      ...
                      <h3 className="text-xl font-medium text-blue-800 hover:underline dark:text-blue-400">
                        {page.metaTitle || "Privacy Policy — Your Company"}
                      </h3>
