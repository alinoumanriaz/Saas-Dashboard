                  ...
                  <div className="bg-muted/50 p-5 rounded-lg border border-border">
                    ...
                    <div className="flex flex-col items-center">
                      <div className="relative group mb-4">
                        <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-background shadow-lg bg-gradient-to-br from-primary to-primary/70">
                          {selectedImage ? (
                      ...
                      <label className="cursor-pointer">
                        <div className="flex items-center justify-center px-4 py-2 border-2 border-dashed border-border rounded-lg hover:border-primary hover:bg-muted transition-colors">
                          <FiUpload className="text-muted-foreground mr-2" />
          ...
          <DialogFooter className="mt-4 border-t border-border ">
            ...
            <Button type="submit" disabled={loading}>
              {loading ? (
                ...
                <>
                  {isEditMode ? <BiCheckCircle className="" /> : <BiPlus className="" />}
