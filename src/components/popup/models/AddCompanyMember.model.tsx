...
//   const availableModules = currentCompanyMember?.modules ?? [];

//   console.log("Available Modules for Current Member:", currentCompanyMember);
...
//       console.log("Selected Data for Edit Mode:", selectedData);
...
// ===================== Static style maps =====================
// Tailwind can't resolve class names built from template strings at build
// time (they get purged), so every color variant used dynamically needs to
// be spelled out here instead of interpolated inline.
...
const AddCompanyMember: React.FC<AddCompanyMemberProps> = ({
  ...
  // --- Tab progress / error state, so users can see problems without
                  ...
                  <TabsContent value="modules" className="mt-0">
                    <Card className="overflow-y-auto! max-h-[60vh]">
                      ...
                      <CardContent className="space-y-4">
                        {watchedModules.map((module: any, index) => {
                          const moduleName =
                            module?.moduleId.moduleName || "Unnamed module";
                          const iconName =
                            module?.moduleId.moduleIcon || "FiDatabase";
